...
func (*Req) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdaa10f35c16ea26, []int{0}
}
...
func (*Res) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdaa10f35c16ea26, []int{1}
}
...
func init() {
	proto.RegisterType((*Req)(nil), "demo1.Req")
	proto.RegisterType((*Res)(nil), "demo1.Res")
}

func init() { proto.RegisterFile("pb/demo1.proto", fileDescriptor_cdaa10f35c16ea26) }

var fileDescriptor_cdaa10f35c16ea26 = []byte{
	// 129 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *waiterClient) DoMD5(ctx context.Context, in *Req, opts ...grpc.CallOption) (*Res, error) {
	out := new(Res)
	err := c.cc.Invoke(ctx, "/demo1.Waiter/DoMD5", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
